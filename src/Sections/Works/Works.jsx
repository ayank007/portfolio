...
const Work = ({pageChange}) => {
    ...
    useEffect(()=>{
        projectLink1.current.addEventListener('click', function(){
			pageChange()
			setTimeout(function(){
				window.location.href=`/portfolio/#/project/project1`;
			},1200)
		})
        projectLink2.current.addEventListener('click', function(){
			pageChange()
			setTimeout(function(){
				window.location.href=`/portfolio/#/project/project2`;
			},1200)
		})
        projectLink3.current.addEventListener('click', function(){
			pageChange()
			setTimeout(function(){
				window.location.href=`/portfolio/#/project/project3`;
			},1200)
		})
        projectLink4.current.addEventListener('click', function(){
			pageChange()
			setTimeout(function(){
				window.location.href=`/portfolio/#/project/project4`;
			},1200)
		})
        projectLink5.current.addEventListener('click', function(){
			pageChange()
			setTimeout(function(){
				window.location.href=`/portfolio/#/project/project5`;
			},1200)
		})
        projectLink0.current.addEventListener('click', function(){
			pageChange()
			setTimeout(function(){
				window.location.href=`/portfolio/#/project/project0`;
			},1200)
		})
    })
    return(
